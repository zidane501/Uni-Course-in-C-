...
*/
    ...
    A[0][0] =  4;  A[0][1] =  6;  A[0][2] = -8;
    A[1][0] =  1;  A[1][1] =  2;  A[1][2] =  3;
    A[2][0] =  6;  A[2][1] =  5; A[2][2]  = -4;
    v[0] = 10; 
    v[1] = 4; 
    v[2] = -7;
/*
...
/*
    ...
    A[2][0] = 2;  A[2][1] =  1;  A[2][2] =  0; A[2][3] =  4;
    A[3][0] = 1;  A[3][1] =  2;  A[3][2] =  5; A[3][3] =  4;

    v[0] =   1; 
    v[1] =   4; 
    v[2] =   5;
    v[3] =   2;
    // The solution is [x,   y,     z,     t]  = [x,   y,   z,    t] = 
    //                 [6, -29/5, 22/5, -18/5] = [6, -5.8, 4.4, -3.6]
    //                 [32/15, -29/15, 8/15, 4/15] = 
    // int N = 3;
 */
/*
    A[0][0] = 1; A[0][1] = 2; A[0][2] = -3;
